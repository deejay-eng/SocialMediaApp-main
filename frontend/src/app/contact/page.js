...
export default function ContactPage() {
  ...
  const socialMedia = [
    {
      name: 'LinkedIn',
      link: 'https://www.linkedin.com/in/dhaani-jain-09b9482a0/',
    ...
    {
      name: 'GitHub',
      link: 'https://github.com/deejay-eng',
    ...
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/dj/',
  ...
  const contactMethods = [
    {
      ...
      action: 'mailto:jaindhaani0919@gmail.com',
